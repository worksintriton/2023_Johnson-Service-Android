...
public class PreventiveMRListOne_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PreventiveMRListOne_Adapter(ArrayList<String> arli_partid, ArrayList<String> arli_partname, ArrayList<String> arli_partno, ArrayList<String> arli_Quantity, Context context) {
                ...
                builder.setMessage("Are You sure want to delete this Item ?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                CommonUtil.dbUtil.deletePMR(holder.partid.getText().toString());
                               //Intent send = new Intent(context, PreventiveMRListOne_Activity.class);
