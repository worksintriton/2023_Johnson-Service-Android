...
public class BreakdownMRListTwo_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BreakdownMRListTwo_Adapter(Context applicationContext, List<Fetch_MrList_Response.Datum> breedTypedataBeanList,  BreakdownMRListtwo_Activity preventiveMRListtwo_activity,
                                      ...
                                      ArrayList<String> arli_partno, ArrayList<String> arli_partname,  BreakdownMRListtwo_Activity getStringremarkListener, ArrayList<String> ar_PartQuantity) {
        ...
        holder.chkSelected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (CommonUtil.dbUtil.hasMRList(Partno,PartName,"1",job_id,service_title)){
                    ...
                    CommonUtil.dbUtil.addMRList(Partno,PartName,"1",job_id,service_title,"0");
                    Cursor cur = CommonUtil.dbUtil.getMRList(job_id,"1",service_title);
                    Log.e("List Count",""+cur.getCount());
                }
        //        else{
