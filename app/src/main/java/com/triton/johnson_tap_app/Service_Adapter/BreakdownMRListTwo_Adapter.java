...
public class BreakdownMRListTwo_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BreakdownMRListTwo_Adapter(Context applicationContext, List<Fetch_MrList_Response.Datum> breedTypedataBeanList, BreakdownMRListtwo_Activity breakdownMrListtwo_activity,
       ...
       try{
        ...
        holder.lin_job_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, BreakdownMRListOne_Activity.class);
