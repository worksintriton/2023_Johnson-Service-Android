...
public class AuditMR_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AuditMR_Adapter(ArrayList<String> arli_partid, ArrayList<String> arli_partname, ArrayList<String> arli_partno, ArrayList<String> arli_Quantity, Context context) {
